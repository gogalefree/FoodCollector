...
let kpublicationDeletedAlertMessage = String.localizedStringWithFormat("Publication ended nearby:", "a message that informs the user that a publication ended")
